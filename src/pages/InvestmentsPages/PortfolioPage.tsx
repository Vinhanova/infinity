                      ...
                      {_.map(purchasedAssetsList, (stock: any) => {
                        ...
                        return (
                          <tr key={stock.id} className='border-t border-white/20 text-sm lg:text-base'>
                            ...
                            <td className='hidden px-[3px] py-[7px] text-right sm:table-cell lg:px-2 lg:py-3 xl:px-6 xl:py-4'>{toFixed(stock.price * userTickersData![stock.id].quantity * exchangeRateInfoData?.c, 2)} €</td>
                          </tr>
                        )
                      })}
                    </tbody>
