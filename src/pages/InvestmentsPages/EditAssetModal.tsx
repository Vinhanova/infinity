...
const EditAssetModal: FC<Props> = ({ setAddAssetModal }) => {
  ...
  return (
    <div className={editAssetModal ? 'custom-gradient fixed min-h-full min-w-full xs:min-h-[calc(100vh-3.5rem)] md:static md:flex md:min-w-min md:bg-custom-dark-jet' : 'hidden'}>
