...
const AddAssetModal: FC<Props> = ({ addAssetModal, setAddAssetModal }) => {
  ...
  return (
    <div className={addAssetModal ? 'custom-gradient fixed min-h-full min-w-full xs:min-h-[calc(100vh-3.5rem)] md:static md:flex md:min-w-min md:bg-custom-dark-jet' : 'hidden'}>
