      ...
      <div className='flex h-full flex-col items-center'>
        <div className='mt-4 mb-2 w-11/12 text-center sm:mb-0 lg:mt-8 xl:mb-6 xl:w-3/4'>
          ...
          <div className='flex-column mt-8 flex flex-wrap items-center justify-between space-y-4 pb-4 sm:flex-row sm:space-y-0'>
            ...
            <div className=''>
              <div className='rtl:inset-r-0 ps-3 pointer-events-none absolute inset-y-0 left-0 flex items-center rtl:right-0'>
              ...
              <input type='text' id='table-search' className='ps-10 block w-80 rounded-lg border border-gray-300 bg-gray-50 p-2 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500' placeholder='Search for items' />
            </div>
          </div>
