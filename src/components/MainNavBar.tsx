...
const MainNavBar = () => {
  return (
    <>
      <div className='flex h-screen w-full transform flex-col justify-between bg-gray-900 sm:w-64 xl:translate-x-0 xl:rounded-r'>
        <div className='mt-6 flex w-full flex-col items-center justify-start space-y-3 pl-4 pb-5 '>
          <button className='jusitfy-start flex w-full items-center space-x-6  rounded  text-white  focus:text-indigo-400 focus:outline-none '>
        ...
        <div className='flex w-full p-6'>
          <div className=' flex w-full items-center justify-between'>
            <div className='flex items-center justify-center  space-x-2'>
              <div>
                <img className='rounded-full' width='30' src='https://play-lh.googleusercontent.com/O8mvDQlw4AwmGfUrh4lviZD_PwwhRHz2etA25F77SbXrm3qEHOt2826aNkKar4D0yw' alt='avatar' />
              </div>
              <div className='flex flex-col items-start justify-start'>
                <p className='cursor-pointer text-sm leading-5 text-white'>Tiago Vinhanova</p>
                <p className='cursor-pointer text-xs leading-3 text-gray-300'>tiago@gmail.com</p>
              </div>
            </div>
