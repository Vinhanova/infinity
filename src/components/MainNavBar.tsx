    ...
    <div className='absolute'>
      <div className='flex h-screen w-16 flex-col justify-between bg-custom-tealblue p-6 text-2xl text-white'>
        <div className='flex w-full flex-col items-center justify-center space-y-2'>
          ...
          <button className='rounded p-2.5 text-xl hover:text-indigo-400 hover:outline-none'>
            <BsFillCalendar2WeekFill />
          </button>
          <button className='rounded p-2 hover:text-indigo-400 hover:outline-none '>
            <GiMeal />
          </button>
          <button className='rounded p-2 hover:text-indigo-400 hover:outline-none '>
            <IoWalletSharp />
      ...
      {/* <div className='flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  '>
          <button className='hover:outline-none hover:text-indigo-400 text-left  text-white flex justify-between items-center w-full py-5 space-x-14  '>
          ...
          <div id='menu1' className='flex justify-start  flex-col w-full md:w-auto items-start pb-1 '>
            <button className='flex justify-start items-center space-x-6 hover:text-white hover:bg-gray-700 hover:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52'>
